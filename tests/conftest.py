...
async def client(db_session: AsyncSession) -> AsyncGenerator[AsyncClient, None]:
    """Создание тестового клиента с переопределением зависимостей."""
...
def mock_department_repo() -> AsyncMock:
    """Создание мок-репозитория департаментов."""
...
def mock_employee_repo() -> AsyncMock:
    """Создание мок-репозитория сотрудников."""
...
def mock_department_service() -> AsyncMock:
    """Создание мок-сервиса департаментов."""
...
def mock_employee_service() -> AsyncMock:
    """Создание мок-сервиса сотрудников."""
...
def department_update_data() -> dict[str, Any]:
    """Тестовые данные для обновления департамента."""
    return {
...
async def department_tree(
    ...
    """Создание дерева департаментов для тестирования."""
...
def create_mock_department(
    ...
    """Вспомогательная функция для создания мок-объекта Department."""
...
def create_mock_employee(
    ...
    """Вспомогательная функция для создания мок-объекта Employee."""
